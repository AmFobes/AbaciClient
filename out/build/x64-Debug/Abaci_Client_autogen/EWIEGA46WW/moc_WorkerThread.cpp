...
QT_MOC_LITERAL(3, 20, 12), // "finishedWork"
QT_MOC_LITERAL(4, 33, 19), // "std::vector<double>"
QT_MOC_LITERAL(5, 53, 5), // "range"
QT_MOC_LITERAL(6, 59, 11), // "workMessage"
QT_MOC_LITERAL(7, 71, 7), // "message"
QT_MOC_LITERAL(8, 79, 10), // "setThreads"
QT_MOC_LITERAL(9, 90, 7), // "threads"
QT_MOC_LITERAL(10, 98, 4), // "work"
QT_MOC_LITERAL(11, 103, 7), // "double*"
QT_MOC_LITERAL(12, 111, 6), // "size_t"
QT_MOC_LITERAL(13, 118, 5) // "count"

    },
    "WorkerThread\0ready\0\0finishedWork\0"
    "std::vector<double>\0range\0workMessage\0"
    "message\0setThreads\0threads\0work\0double*\0"
    "size_t\0count"
};
...
static const uint qt_meta_data_WorkerThread[] = {
 ...
 // slots: parameters
    ...
    QMetaType::Void,
    QMetaType::Void, 0x80000000 | 11, 0x80000000 | 12,    5,   13,
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->finishedWork((*reinterpret_cast< std::vector<double>(*)>(_a[1]))); break;
        case 2: _t->workMessage((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 3: _t->setThreads((*reinterpret_cast< uint(*)>(_a[1]))); break;
        case 4: _t->setThreads(); break;
        case 5: _t->work((*reinterpret_cast< double*(*)>(_a[1])),(*reinterpret_cast< size_t(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::ready)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (WorkerThread::*)(std::vector<double> );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::finishedWork)) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WorkerThread::workMessage)) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void WorkerThread::finishedWork(std::vector<double> _t1)
{
...
// SIGNAL 2
void WorkerThread::workMessage(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
