...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        formLayout_3->setWidget(2, QFormLayout::SpanningRole, lblConfigurationTitle);

        chkautoReqWork = new QCheckBox(centralwidget);
        chkautoReqWork->setObjectName(QString::fromUtf8("chkautoReqWork"));
        chkautoReqWork->setEnabled(false);

        formLayout_3->setWidget(5, QFormLayout::LabelRole, chkautoReqWork);

        numRequest = new QSpinBox(centralwidget);
        numRequest->setObjectName(QString::fromUtf8("numRequest"));
        numRequest->setEnabled(false);
        numRequest->setMinimum(1);
        numRequest->setMaximum(1000);

        formLayout_3->setWidget(5, QFormLayout::FieldRole, numRequest);

        horizontalSpacer = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        formLayout_3->setItem(6, QFormLayout::SpanningRole, horizontalSpacer);
        ...
        btnRequestWork->setEnabled(false);

        formLayout_3->setWidget(3, QFormLayout::LabelRole, btnRequestWork);
        ...
        btnEditClientInfo->setEnabled(false);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        chkautoReqWork->setText(QApplication::translate("MainWindow", "Request work every second:", nullptr));
        ...
        lblStatus->setText(QApplication::translate("MainWindow", "Idle", nullptr));
